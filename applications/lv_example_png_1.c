...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_PNG_DECODER_TEST uint8_t img_wink_png_map1[] = {
...
const lv_img_dsc_t img_wink_png1 = {
    .header.always_zero = 0,
    .header.w = 50,
    .header.h = 50,
    .data_size = 5158,
    .header.cf = LV_IMG_CF_RAW_ALPHA,
    .data = img_wink_png_map1,
};
...
//    LV_IMG_DECLARE(img_wink_png);
    ...
    lv_img_set_src(img, &img_wink_png1);
